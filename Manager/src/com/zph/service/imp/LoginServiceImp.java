...
public class LoginServiceImp implements LoginService {
	private static final String LOGINLGO = "login/loginlog.zph";
	private static final String REGISE = "login/user.zph";
	...
	public String writeLoginLog(String name, Date time) {
		...
		FileUtil.writeByFileReader(LOGINLGO, sb.toString());
		return null;
	}
	...
	public String checkLogin(String name, String password) {
		String message = "";
		List<String> list = FileUtil.readByBufferedReader(REGISE);
